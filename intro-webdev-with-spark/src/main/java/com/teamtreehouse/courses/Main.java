...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*psvm = public static void main (tabbed)
        get("/hello", (req, res) -> "Hello World");
        */

        CourseIdeaDAO dao = new SimpleCourseIdeaDAO();

        before((req, res) -> { //if no string is given it goes for all routes
        ...
        before("/ideas", (req, res) -> {
            if (req.attribute("username") == null){
                setFlashMessage(req, "Whoops please signin first!");
                res.redirect("/");
                halt();
            }
        });
        ...
        post("/ideas/:slug/vote", (req, res) -> {
            ...
            if (added){
                setFlashMessage(req, "Thanks for the vote!");
            }else{
