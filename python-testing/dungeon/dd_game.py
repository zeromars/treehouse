...
def build_cells(width, height):
    """Create and return a width and a height grid of two tuples
...
def get_locations(cells):
    """Randomly pick starting locations for the monster player and door
...
def get_moves(player):
    """Based on the tuple of the players position return the list of accetable moves
